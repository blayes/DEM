...
if (nid == 2) {
    rnms <- paste0("cv_", cid, "_p_", fid, "_q_", rid, "_n_1e4_k_", nw, "_iem.rds")
} else {
    rnms <- paste0("cv_", cid, "_p_", fid, "_q_", rid, "_n_1e5_k_", nw,  "_iem.rds")
}

fname <- paste0("/Shared/ssrivastva/dem/mixef/result/iem/iem_res_", rnms)
saveRDS(res, fname)
